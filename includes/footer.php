      ...
      <div class="row1 bg-light-green">
        <div class="main-content align-text-c">
          ...
          <form action="index.php" method="POST" id="contact" enctype="multipart/form-data">
            <div class="cta-box">
              <label for="mailing">
              <input class="cta-input" type="email" name="mailing" id="mailing" placeholder="Courriel"><button aria-label="envoyer mon adresse courriel" class="btn-mailing"><i class="fas fa-paper-plane"></i></button></label>
            </div>
